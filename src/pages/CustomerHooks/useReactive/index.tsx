    ...
    return (
        <div style={{ padding: 20 }}>
            ...
            <div style={{ margin: '8px 0', display: 'flex', justifyContent: 'flex-start' }}>
                ...
                <Button type="primary" style={{ marginLeft: 8 }} onClick={() => state.count--}>
                    减1
                </Button>
                <Button type="primary" style={{ marginLeft: 8 }} onClick={() => (state.count = 7)}>
                    设置为7
                </Button>
            </div>
            ...
            <div style={{ margin: '8px 0', display: 'flex', justifyContent: 'flex-start' }}>
                ...
                <Button type="primary" style={{ marginLeft: 8 }} onClick={() => (state.name = 'Domesy')}>
                    设置为Domesy
                </Button>
            </div>
            ...
            <div style={{ margin: '8px 0', display: 'flex', justifyContent: 'flex-start' }}>
                <Button type="primary" onClick={() => state.arr.push(Math.floor(Math.random() * 100))}>
                    push
                </Button>
                <Button type="primary" style={{ marginLeft: 8 }} onClick={() => state.arr.pop()}>
                    pop
                </Button>
                <Button type="primary" style={{ marginLeft: 8 }} onClick={() => state.arr.shift()}>
                    shift
                </Button>
                <Button
                    type="primary"
                ...
                <Button type="primary" style={{ marginLeft: 8 }} onClick={() => state.arr.reverse()}>
                    reverse
                </Button>
                <Button type="primary" style={{ marginLeft: 8 }} onClick={() => state.arr.sort()}>
                    sort
                </Button>
            </div>
            ...
            <div style={{ margin: '8px 0' }}>
                <form
                    ...
                    <Button type="danger" style={{ marginLeft: 8 }} onClick={() => state.bugs.pop()}>
                        删除
                    </Button>
                </form>
            </div>
